...
/**
 * S10 T1: Marketing is a secondary module not in the core T1 scope
...
export default function Marketing() {
  return (
    <div className="space-y-5 -mt-6">
      <PageHeader title="Marketing" description="Post-T1 module — production wiring pending" />
      <Panel>
        <EmptyState
          title="Marketing — not yet wired to production backend"

...
/**
 * S10 T1: Settings is a secondary module not in the core T1 scope
...
export default function Settings() {
  return (
    <div className="space-y-5 -mt-6">
      <PageHeader title="Settings" description="Post-T1 module — production wiring pending" />
      <Panel>
        <EmptyState
          title="Settings — not yet wired to production backend"

...
export class OperationsController {
  ...
  @Patch('checklists/:id/status') @RequirePermission('operations', 'edit') checklistStatus(@Req() req: AuthedRequest, @Param('id') id: string, @Body() body: unknown) { return this.service.transitionChecklist(req.principal!, id, body); }
  ...
  @Patch('tasks/:id/status') @RequirePermission('operations', 'edit') taskStatus(@Req() req: AuthedRequest, @Param('id') id: string, @Body() body: unknown) { return this.service.transitionTask(req.principal!, id, body); }
  ...
  @Patch('lab-cases/:id/status') @RequirePermission('operations', 'edit') labCaseStatus(@Req() req: AuthedRequest, @Param('id') id: string, @Body() body: unknown) { return this.service.transitionLabCase(req.principal!, id, body); }
  ...
  @Patch('incidents/:id/status') @RequirePermission('operations', 'edit') incidentStatus(@Req() req: AuthedRequest, @Param('id') id: string, @Body() body: unknown) { return this.service.transitionIncident(req.principal!, id, body); }
}

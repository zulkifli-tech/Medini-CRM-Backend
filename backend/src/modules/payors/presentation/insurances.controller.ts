...
/**
 * InsurancesController — Insurance master data API (Sprint 2A T4).
 * Permission domain key: 'finance' (same as Panels — ROLE_DOMAIN_MATRIX
 * unchanged). HQ-only writes enforced by the service + T1 RLS WITH CHECK.
 */
@Controller({ path: 'insurances', version: '1' })
